...
import { getCart } from "../utils/cart"; // usamos tu helper
...
function NavBar() {
    ...
    useEffect(() => {
        ...
        // se actualiza si alguien emite el evento personalizado
        const onCustom = () => syncCartCount();
        // se actualiza si cambia localStorage (otras pestañas)
